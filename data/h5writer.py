...
chain3_reaction_data = np.array([
    ("U235",1,3.12e-17,0,99.3843,586.691,json.dumps([[100, 0.961], [200, 0.9457], [400, 0.9294], [600, 0.9229]]),"U236"),
    ("U236",0,9.38E-16,1,5.13396,0,json.dumps([[100, 1], [200, 1], [400, 1], [600, 1]]),"Np237"),
    ("Np237",0,1.03E-14,1,175.43,0,json.dumps([[100, 1], [200, 1], [400, 1], [600, 1]]),"Pu238"),
    ("Pu238",0,2.51E-10,1,412.855,0,json.dumps([[100, 1], [200, 1], [400, 1], [600, 1]]),"Pu239"),
    ("U238",0,4.92E-18,1,2.73,0,json.dumps([[100, 1.0031], [200, 1.0049], [400, 1.0085], [600, 1.0122]]),"Np239"),
...
chain4_reaction_data = np.array([
    ("U238",0,4.92E-18,1,2.73,0,json.dumps([[100, 1.0031], [200, 1.0049], [400, 1.0085], [600, 1.0122]]),"U239"),
    ("U239",1,0.000502281,0,22,0,json.dumps([[100, 1], [200, 1], [400, 1], [600, 1]]),"Np239"),
    ("U239",0,0.000502281,1,22,0,json.dumps([[100, 1], [200, 1], [400, 1], [600, 1]]),"U240"),
    ("Np239",1,3.41E-06,0,30,0,json.dumps([[100, 1], [200, 1], [400, 1], [600, 1]]),"Pu239"),
    ("Np239",0,3.41E-06,1,30,0,json.dumps([[100, 1], [200, 1], [400, 1], [600, 1]]),"Np240"),    
    ("Pu239",0,9.12E-13,1,274,0,json.dumps([[100, 1.1611], [200, 1.3388], [400, 1.8905], [600, 2.5321]]),"Pu240"),
    ("U240",1,1.37529E-05,0,19.1675,0,json.dumps([[100, 1], [200, 1], [400, 1], [600, 1]]),"Np240"),
    ("Np240",1,0.00165035,0,0,0,json.dumps([[100, 1], [200, 1], [400, 1], [600, 1]]),"Pu240"),
    ("Pu240",0,3.35E-12,1,286,0,json.dumps([[100, 1], [200, 1], [400, 1], [600, 1]]),"Pu241"),
    ("Pu241",0,1.53E-09,1,363.047,0,json.dumps([[100, 1], [200, 1], [400, 1], [600, 1]]),"Pu242"),
    ("Pu241",1,1.53E-09,0,363.047,0,json.dumps([[100, 1], [200, 1], [400, 1], [600, 1]]),"Am241")
], dtype=reaction_dtype)
